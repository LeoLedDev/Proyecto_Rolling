          ...
          <Form className="w-25">
            ...
            <Form.Group className="mb-3" controlId="formBasicEmail">
              <Form.Label>
                ...
                Usuario</Form.Label>
              <Form.Control type="text" name='user' value={values.user} className={errors.user && touched.user && errors.user && 'is-invalid'} onChange={handleChange} maxLength={16} min={4} />
            ...
            Contraseña</Form.Label>
              <Form.Control type="password" name="password" value={values.password} className={errors.password && touched.password && errors.password && 'is-invalid'} onChange={handleChange} maxLength={16} min={8}  />
            ...
            Repetir Contraseña</Form.Label>
              <Form.Control type="password" name="rpassword" value={values.rpassword} className={errors.rpassword && touched.rpassword && errors.rpassword && 'is-invalid'} onChange={handleChange} maxLength={16} min={8}  />
